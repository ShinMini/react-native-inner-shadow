...
const DEFAULT_REFLECTED_LIGHT_COLOR = '#eee9e92d';
const DEFAULT_SHADOW_COLOR = '#2F2F2FBC';
 ...
 * */
const DEFAULT_SHADOW_BLUR = 3;
const DEFAULT_REFLECTED_LIGHT_BLUR = 3;
