...
import ShadowView from 'InnerShadowView';
import LinearShadowView from 'LinearInnerShadowView';

function InnerShadowExample(): React.JSX.Element {
  return (
...
export default InnerShadowExample;
